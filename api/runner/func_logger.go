...
// FuncLogger reads STDERR output from a container and outputs it in a parseable structured log format, see: https://github.com/pedronasser/functions/issues/76
