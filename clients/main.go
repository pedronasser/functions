...
func main() {
	...
	for _, language := range languages {
		...
		case "ruby":
			...
			options["gemHomepage"] = "https://github.com/pedronasser/functions_ruby"
		...
		exec.Command("git", "clone", fmt.Sprintf("git@github.com:pedronasser/functions_%s.git", short), srcDir).Run()
