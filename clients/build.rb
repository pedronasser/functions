...
swaggerUrl = "https://raw.githubusercontent.com/pedronasser/functions/master/docs/swagger.yml"
...
languages.each do |l|
  ...
  if l == 'go'
    ...
    # dep ensure --update && docker run --rm -it  -v $HOME/dev/go:/go -w /go/src/github.com/iron-io/functions_go quay.io/goswagger/swagger generate client -f https://raw.githubusercontent.com/pedronasser/functions/master/docs/swagger.yml -A functions
  else
